          ...
          <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
            ...
            <div className="relative space-y-4">
              <p className="text-white">
                Hello! I'm Mian Asif, a passionate Full-Stack Developer specializing in building scalable web applications, intuitive user interfaces, and robust backend systems. I enjoy turning complex problems into clean, efficient solutions using modern JavaScript technologies{" "}
